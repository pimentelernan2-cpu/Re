...
public class GuestList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton3.setText("Prepare not to say");
...
try {
    ...
    String sql = "UPDATE guest SET FName=?, LName=?, MName=?, Suffix=?, Age=?, Contact=?, Gender=?, Address=? WHERE GuestID=?";
    ...
    try {
        ...
        PreparedStatement stmt = con.prepareStatement(sql);
        stmt.setString(1, jGuestID.getText());
